...
var ssl_key = fs.readFileSync(path.join(__dirname, resolveURL('keys/privatekey.key')));
var ssl_cert = fs.readFileSync(path.join(__dirname, resolveURL('keys/certificate.crt')));
